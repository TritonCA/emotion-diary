...
// Optional release signing via android/key.properties (CI populates this
// from secrets). When absent we fall back to debug signing so local
...
android {
    ...
    compileOptions {
        ...
        // need desugaring on older Android versions).
